---
description: Answers to frequently asked general questions
title: General
...
There are limits in place when using the free version of Husqy. That is why we have introduced a 
[premium](https://husqy.xyz/premium) subscription. 
...
- Join our [Discord server](https://discord.gg/ZgsUhSEr43) to get all the help you need;
...
Husqy variables are not supported in all functions or modules, therefore if variables do not change to a value, that specific function does not support it (yet). If you have want a specific function to add support for Husqy variables, please join our [Discord server](https://discord.gg/ZgsUhSEr43) and open a ticket or, if that is not an option email us at info@husqy.xyz.

## I want to use a Husqy variable but it does not exist, what can I do?

If a desired Husqy variable does not exist, please join our [Discord server](https://discord.gg/ZgsUhSEr43) and open a ticket or, if that is not an option email us at info@husqy.xyz.
