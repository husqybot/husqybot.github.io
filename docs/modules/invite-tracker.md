...
3. `Join message is embed`: If the join message content is an Husqy embed JSON config, see [Utils custom embeds](https://husqy.xyz/docs/functions/utils#custom-embeds);
...
7. `Leave message is embed`: If the leave message content is an Husqy embed JSON config, see [Utils custom embeds](https://husqy.xyz/docs/functions/utils#custom-embeds);
...
3. Using the [Invite tracker dashboard](#additional-info--commands);
   <br />
   :::note
